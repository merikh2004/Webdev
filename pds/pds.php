...
<head>
  ...
  <style>
    ...
    .btn-custom:hover {
      background: linear-gradient(90deg, #157347, #1aa179);
      color: white;
    }
    table thead {
  ...
  <div class="container my-5">
    ...
    <div class="card shadow-lg mb-5">
      <div class="card-header bg-success bg-gradient text-white">
        <h4 class="mb-0"><i class="bi bi-person-fill me-2"></i>Personal Data Sheet</h4>
      </div>
      <div class="card-body">
        <form method="post" class="row g-3">
          ...
          <div class="col-12">
            <h5 class="mt-4 text-success">Residential Address</h5>
          </div>
          <div class="col-md-4">
          ...
          <div class="col-12">
            <h5 class="mt-4 text-success">Permanent Address</h5>
          </div>
          <div class="col-md-4">
            <label class="form-label">Street</label>
          ...
          <div class="col-12 text-center mt-4">
            <button type="submit" class="btn btn-custom px-5">Save Information</button>
          </div>
        </form>
      </div>
    </div>
    ...
    <div class="card shadow-lg">
      <div class="card-header bg-dark bg-gradient text-white">
        <h5 class="mb-0"><i class="bi bi-card-list me-2"></i>PDS Records</h5>
      </div>
      <div class="card-body">
            ...
            if ($rs = $conn->query($sql)) {
              if ($rs->num_rows > 0) {
                ...
                while ($row = $rs->fetch_assoc()) {
                  echo "<tr>"
                    . "<td>" . $cnt . "</td>"
                    . "<td><strong>" . $row['pds_surname'] . ", " . $row['pds_first_name'] . " " . $row['pds_middle_name'] . "</strong></td>"
                    . "<td>" . $row['pds_date_of_birth'] . "</td>"
                    . "<td>" . $row['pds_sex'] . "</td>"
                    . "<td>" . $row['pds_civil_status'] . "</td>"
                    . "<td>" . $row['pds_mobile'] . "<br><small class='text-muted'>" . $row['pds_email'] . "</small></td>"
                    . "<td>
                        <a href='view.php?token=" . $row['pds_person_id'] . "' class='btn btn-warning btn-sm'>View</a> 
                ...
                echo "<tr><td colspan='7' class='text-center text-muted'>No Record(s) Found!</td></tr>";
              }
            }
            ?>
          </tbody>
